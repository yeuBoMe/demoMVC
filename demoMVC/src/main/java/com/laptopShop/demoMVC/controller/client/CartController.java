...
import com.laptopShop.demoMVC.service.CartService;
...
public class CartController {
    ...
    public String getCartDetailPage(HttpServletRequest request, Model model) {
        ...
        List<CartDetail> cartDetails = cartGetByUser != null
                ? cartGetByUser.getCartDetails()
    ...
    public String handlePlaceOrderRequest(
            Model model,
