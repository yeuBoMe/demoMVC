...
import com.laptopShop.demoMVC.service.upload.UploadService;
...
public class ProductController {
    ...
    public String getDetailProductPage(Model model, @PathVariable long id) {
        Product productGetById = this.productService.getProductById(id);
    ...
    public String handleCreateProductRequest(
            Model model,
    ...
    public String handleUpdateProductRequest(
            Model model,
        ...
        if (this.productService.checkProductExistsWithName(product.getName())
                && !currentProduct.getName().equals(product.getName())) {
        ...
        // Kiểm tra trùng tên và hãng, loại trừ sản phẩm hiện tại
        if (this.productService.checkProductExistsWithNameAndFactory(product.getName(), product.getFactory())
                && !(currentProduct.getName().equals(product.getName())
                && currentProduct.getFactory().equals(product.getFactory()))) {
            updateProductBindingResult.addError(
                    new FieldError(
                            "updateProduct",
                            "name",
    ...
    public String handleDeleteProductRequest(
            Model model,
