...
import com.laptopShop.demoMVC.domain.*;
import com.laptopShop.demoMVC.domain.dto.ProductCriteriaDTO;
import com.laptopShop.demoMVC.repository.*;
import com.laptopShop.demoMVC.service.send.SendEmailService;
import com.laptopShop.demoMVC.service.spec.ProductSpecs;
...
public class ProductService {
    ...
    public void handleAddProductToCart(
        ...
        if (userGetByEmail != null) {
            ...
            if (productOptional.isPresent()) {
                ...
                CartDetail oldCartDetail = this.cartDetailRepository.findByCartAndProduct(cartGetByUser,
                        productGetById);
    ...
    public Page<Product> getProductsWithSpecs(Pageable pageable, ProductCriteriaDTO productCriteriaDTO) {
        ...
        Specification<Product> combinedSpec = (root, query, cb) -> null;
